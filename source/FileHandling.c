...
int loadSettings() {
	...
	g_dipSwitch0 = cfg.dipSwitchRE0;
	g_dipSwitch1 = cfg.dipSwitchRE1;
	g_dipSwitch2 = cfg.dipSwitchRE2;
	g_dipSwitch3 = cfg.dipSwitchRE3;
...
void saveSettings() {
	...
	cfg.dipSwitchRE0 = g_dipSwitch0;
	cfg.dipSwitchRE1 = g_dipSwitch1;
	cfg.dipSwitchRE2 = g_dipSwitch2;
	cfg.dipSwitchRE3 = g_dipSwitch3;
