...
//---------------------------------------------------------------------------------
	...
	REG_BG0CNT = BG_32x32 | BG_MAP_BASE(0) | BG_TILE_BASE(1) | BG_PRIORITY(1);
	REG_BG1CNT = BG_32x32 | BG_MAP_BASE(2) | BG_TILE_BASE(2) | BG_PRIORITY(2);
	...
	REG_BG0CNT_SUB = BG_MAP_BASE(0) | BG_COLOR_16;
	REG_BG1CNT_SUB = BG_MAP_BASE(1) | BG_COLOR_16;
	REG_BG1HOFS_SUB = 0;
	REG_BG1VOFS_SUB = 0;
